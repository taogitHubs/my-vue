...
//使用Vue来安装插件
__WEBPACK_IMPORTED_MODULE_1__vue_router_js___default.a.use(__WEBPACK_IMPORTED_MODULE_0__vue_js___default.a);

// 创建路由对象
var router = new __WEBPACK_IMPORTED_MODULE_0__vue_js___default.a();
// 配置路由规则
router .addRoutes([
    //path代表锚点值,component要填坑的组件
    {path:'/home',component:__WEBPACK_IMPORTED_MODULE_2__Home_js__["a" /* default */]},//锚点值匹配才显示
]);
// 配置好的路由对象交给Vue
new __WEBPACK_IMPORTED_MODULE_1__vue_router_js___default.a({
    el:'#app',
    render:c=>c(__WEBPACK_IMPORTED_MODULE_3__App_js__["a" /* default */]), //App是一定会显示
    // router:router 
    router
});
// 留坑
